  ...
  <View style={styles.container}>
      ...
      <View style={{backgroundColor:"#ffffff",flexDirection:'row'}}>
         <View style={{height:100,flex:3,borderRadius:100, justifyContent:"center",alignItems:"center"}}>
           <Image source={require('../AppleSettings/assets/images/1.jpg')} style={{width:80, height:80, borderRadius:100}} />
         </View>
 ...
 <View style={styles.finishing}>
  ...
  <View style={{flexDirection:'row', backgroundColor:'#ffffff', justifyContent:'space-between',borderTopWidth:0.3,borderColor:'#dedede',height:50,alignItems:'center'}}>
    ...
    <View style={{flex:6,alignItems:'flex-end',marginRight:10}}>
        <Text style={{color:'#aaa',fontSize:17,fontWeight:'normal'}}>STUDENT</Text>
    </View>
     <View style={{flex:1}}>
     <Ionicons 
              name="ios-arrow-forward"
  ...
  <View style={{flexDirection:'row', backgroundColor:'#ffffff', justifyContent:'space-between',borderTopWidth:0.3,borderColor:'#dedede',height:50,alignItems:'center'}}>
    ...
    <View style={{flex:4,alignItems:'flex-end',marginRight:10}}>
        <Text style={{color:'#aaa',fontSize:17,fontWeight:'normal'}}>Off</Text>
    </View>
     <View style={{flex:1}}>
     <Ionicons 
              name="ios-arrow-forward"
  ...
  <View style={{flexDirection:'row', backgroundColor:'#ffffff', justifyContent:'space-between',borderTopWidth:0.3,borderColor:'#dedede',height:40,alignItems:'center'}}>
    <View style={{flex:1.8,backgroundColor:"blue", height:25, justifyContent:'center',alignItems:'center',marginLeft:10, borderRadius:9}} >
      <MaterialIcons 
              name='vpn-key'
              color="white"
              size={20}
    ...
    <View style={{flex:7,marginLeft:20}}> 
       <Text style={{fontSize:15,fontWeight:'normal'}}>VPN</Text>
    </View>
    <View style={{flex:10,alignItems:'flex-end',marginRight:10}}>
        <Text style={{color:'#aaa',fontSize:17,fontWeight:'normal'}}>Not Connected</Text>
    </View>
    <View style={{flex:2}}>
     <Ionicons 
              name="ios-arrow-forward"
